    ...
    return (
        <div className="w-72 h-screen bg-footerBg text-white flex flex-col fixed left-0 top-0 z-50 overflow-hidden" style={{ overscrollBehavior: 'contain' }} data-lenis-prevent>
            ...
            <nav className="flex-1 overflow-y-auto py-6 px-4 space-y-1 custom-scrollbar" style={{ overscrollBehavior: 'contain' }} data-lenis-prevent>
                ...
                {/* Items Before Products (Dashboard to Categories) */}
                ...
                <div className="mt-1">
                    ...
                    {openSection === 'homepage' && (
                        <div className="mt-1 ml-4 pl-4 border-l border-white/10 space-y-1">
                            ...
                            <Link
                                to="/admin/sections/today-top-deal"
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all text-sm ${location.pathname === '/admin/sections/today-top-deal'
                                    ? 'bg-primary/20 text-white'
                                    : 'text-gray-400 hover:bg-white/5 hover:text-white'
                                    }`}
                            >
                                <Activity size={16} />
                                <span className="font-semibold">Today Top Deal</span>
                            </Link>
                            <Link
                                to="/admin/sections/special-offers"
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all text-sm ${location.pathname === '/admin/sections/special-offers'
                                    ? 'bg-primary/20 text-white'
                                    : 'text-gray-400 hover:bg-white/5 hover:text-white'
                                    }`}
                            >
                            ...
                            <Link
                                to="/admin/sections/new-products"
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all text-sm ${location.pathname === '/admin/sections/new-products'
                                    ? 'bg-primary/20 text-white'
                                    : 'text-gray-400 hover:bg-white/5 hover:text-white'
                                    }`}
                            >
