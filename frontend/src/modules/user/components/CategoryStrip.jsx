...
const colors = [
    'bg-[#F4C542]', 'bg-[#7B5CF1]', 'bg-[#E84AA6]',
    'bg-[#FF8A3D]', 'bg-[#6ED3B1]', 'bg-[#5BC0EB]',
    'bg-[#FFB4A2]', 'bg-[#B497FF]', 'bg-[#FF6B6B]',
    'bg-[#2EC4B6]'
];
...
const CategoryStrip = () => {
    ...
    return (
        <section className="bg-background pt-10 pb-1 md:pt-16 md:pb-4 px-4 md:px-24 relative overflow-hidden">
            {/* ... header ... */}
            <div className="container mx-auto">
                <div className="text-center mb-2 md:mb-14 space-y-1 md:space-y-2">
                    <motion.span
                        ...
                        className="text-secondary font-bold tracking-[0.3em] uppercase text-[10px] block opacity-80"
                    >
                        Fresh from Farm
                    </motion.span>
                    <motion.h2
                ...
                <div className="relative flex items-center group">
                    ...
                    <button
                        onClick={() => scroll('left')}
                        className="absolute -left-2 md:-left-20 top-1/2 -translate-y-1/2 z-20 bg-background shadow-lg p-3 rounded-full text-textPrimary hover:bg-primary hover:text-white transition-all active:scale-90 border border-gray-100 hidden md:flex items-center justify-center"
                    >
                        <ChevronLeft size={24} />
                    </button>
                    ...
                    >
                        {isLoading ? (
                            ...
                            <div className="text-center w-full text-gray-400 text-xs font-bold uppercase tracking-widest border-2 border-dashed border-gray-100 p-8 rounded-xl">
                                ...
                                <p className="text-[10px] mt-1 normal-case text-gray-300">Enable "In Shop Strip" in Admin &gt; Categories</p>
                            </div>
                        ) : (
                    ...
                    <button
                        ...
                        className="absolute -right-2 md:-right-20 top-1/2 -translate-y-1/2 z-20 bg-background shadow-lg p-3 rounded-full text-textPrimary hover:bg-primary hover:text-white transition-all active:scale-90 border border-gray-100 hidden md:flex items-center justify-center"
                    >
