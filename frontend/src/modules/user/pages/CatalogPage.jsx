            ...
            <div className="lg:hidden container mx-auto px-4 mb-3 flex gap-2 sticky top-[70px] z-30 bg-white py-2">
                ...
                <div className="flex-1 relative">
                    <button
                        ...
                        className="w-full border border-secondary/40 rounded-lg py-2 flex items-center justify-center gap-1.5 bg-background"
                    >
                        <span className="text-[10px] font-black text-textPrimary uppercase tracking-widest">Sort By</span>
                        <ChevronDown size={12} strokeWidth={2.5} className="text-secondary" />
                    </button>
                </div>
            </div>
                        ...
                        <>
                            ...
                            >
                                <div className="flex items-center justify-between p-4 border-b border-secondary/20">
                                    ...
                                    <button onClick={() => setIsSortMenuOpen(false)} className="p-1.5 bg-white rounded-full border border-secondary/20">
                                    ...
                                    {sortOptions.map(option => (
                                        <button
                                            ...
                                            className={`w-full text-left py-2.5 px-3 rounded-xl flex items-center justify-between transition-colors border ${sortBy === option.value
                                                ...
                                                : 'border-transparent text-textPrimary/80 hover:bg-white font-medium'
                                                }`}
                                        >
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center gap-2.5 px-4 py-1.5 md:px-6 md:py-2 border border-secondary/40 rounded-xl bg-background transition-all hover:bg-white"
                                >
                                    <span className="text-xs md:text-[13px] font-bold text-textPrimary font-['Poppins']">
                                        Sort By
                                    </span>
                                    <ChevronDown size={14} className={`text-secondary transition-transform ${isDesktopSortOpen ? 'rotate-180' : ''}`} />
                                </button>
                                    ...
                                    {isDesktopSortOpen && (
                                        <>
                                            ...
                                            <motion.div
                                                ...
                                                exit={{ opacity: 0, y: 10 }}
                                                className="absolute right-0 top-full mt-2 w-56 bg-background border border-secondary/20 rounded-xl shadow-xl z-20 overflow-hidden"
                                            >
                                                <div className="py-1">
                                                    {sortOptions.map(option => (
                                                        <button
                                                            ...
                                                            className={`w-full text-left px-4 py-2.5 text-sm flex items-center justify-between hover:bg-white transition-colors ${sortBy === option.value ? 'font-bold text-secondary bg-secondary/10' : 'text-textPrimary/80'
                                                                }`}
                                                        >
                                                            {option.label}
